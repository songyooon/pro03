	...
	<form name="frm1" id="frm1" action="${path1 }/AddUserCtrl.do" method="post" onsubmit="return joinCheck(this)">
		<table class="table">
			<tbody>
				<tr>
					...
					<td>
						<div class="form-row">
							...
							<input type="button" class="button is-success is-outlined" value="아이디 중복 확인" onclick="idCheck()">
						...
						<div>
							...
							<p id="msg" style="padding-left:0.5rem">아이디 중복 체크 후 수정했습니다</p>
							</c:if>
						</div>
					</td>
				</tr>
				...
				<tr>
					<th>연락처</th>
					<td><input type="tel" name="tel" id="tel" maxlength="11" placeholder="전화번호 - 제외하고 숫자만 입력" class="input" required></td>
				</tr>
				<tr>
					<th>주소</th>
					...
					<button id="post_btn" onclick="findAddr()" class="button is-success is-outlined">우편번호 검색</button>
					</td>
				</tr>
			</tbody>
		</table>
		<div class="btn-group">
			<input type="submit" name="submit-btn" class="button is-success is-outlined" value="회원가입">
			<input type="reset" name="reset-btn" class="button is-success is-outlined" value="취소">
		</div>
	</form>	
	<script>
